...
function PopupEdit(props) {
  ...
  useEffect(() => {
    priorityRef.current.value = props.editCard.priority;
    statusRef.current.value = props.editCard.status;
  }, [props.editCard]);

  function editNewCard() {
    props.editNewCard({
      cardId: props.editCard.cardId,
  ...
  return (
    <div
      className={`popup popup-add-card ${
        props.editCard.isOpen ? 'popup_opened' : ''
      }`}
      ...
      <div className='popup-add-card__wrapper'>
        ...
        <form className='form'>
          <input
            ...
            required
            ref={titleRef}
            defaultValue={props.editCard.title}
          />
          <textarea
            ...
            required
            ref={descriptionRef}
            defaultValue={props.editCard.description}
          ></textarea>
          <input
            ...
            required
            ref={dateRef}
            defaultValue={props.editCard.date}
          />
          ...
          <label htmlFor='status' className='form__label'>
            ...
            >
              ...
              <option value='ready'>Завершенная</option>
            </select>
          </label>
          <button type='button' className='form__ready' onClick={editNewCard}>
            Изменить
          </button>
        </form>
      </div>
